...
export const proposalApi = {
  generate: (data: { rfpId: string; templateId: string; title: string; customContent?: any }) =>
  ...
  update: (id: string, data: any) => api.put<Proposal>(`/api/proposals/${id}`, data),
  delete: (id: string) => api.delete(`/api/proposals/${id}`),
  exportPdf: (id: string) => api.get(`/api/proposals/${id}/export/pdf`, { responseType: 'blob' })
}
...
export const templateApi = {
  ...
  preview: (id: string, rfpData?: any) => api.get(`/api/templates/${id}/preview`, { params: rfpData })
}
...
export const contentApi = {
  ...
  getReferences: (projectType?: string) => api.get('/api/content/references', { 
